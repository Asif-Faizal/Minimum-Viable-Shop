...
const (
	OrderService_CreateOrUpdateOrder_FullMethodName = "/pb.OrderService/CreateOrUpdateOrder"
...
type OrderServiceClient interface {
	CreateOrUpdateOrder(ctx context.Context, in *CreateOrUpdateOrderRequest, opts ...grpc.CallOption) (*CreateOrUpdateOrderResponse, error)
...
func (c *orderServiceClient) CreateOrUpdateOrder(ctx context.Context, in *CreateOrUpdateOrderRequest, opts ...grpc.CallOption) (*CreateOrUpdateOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOrUpdateOrderResponse)
	err := c.cc.Invoke(ctx, OrderService_CreateOrUpdateOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	CreateOrUpdateOrder(context.Context, *CreateOrUpdateOrderRequest) (*CreateOrUpdateOrderResponse, error)
...
func (UnimplementedOrderServiceServer) CreateOrUpdateOrder(context.Context, *CreateOrUpdateOrderRequest) (*CreateOrUpdateOrderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateOrUpdateOrder not implemented")
}
...
func _OrderService_CreateOrUpdateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateOrUpdateOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).CreateOrUpdateOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_CreateOrUpdateOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).CreateOrUpdateOrder(ctx, req.(*CreateOrUpdateOrderRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OrderService_CreateOrUpdateOrder_Handler,
		},
		{

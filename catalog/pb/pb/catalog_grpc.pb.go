...
const (
	CatalogService_CreateOrUpdateProduct_FullMethodName = "/pb.CatalogService/CreateOrUpdateProduct"
	CatalogService_GetProductByID_FullMethodName        = "/pb.CatalogService/GetProductByID"
	CatalogService_ListProducts_FullMethodName          = "/pb.CatalogService/ListProducts"
	CatalogService_ListProductsWithIds_FullMethodName   = "/pb.CatalogService/ListProductsWithIds"
...
type CatalogServiceClient interface {
	...
	ListProductsWithIds(ctx context.Context, in *ListProductsWithIdsRequest, opts ...grpc.CallOption) (*ListProductsWithIdsResponse, error)
...
func (c *catalogServiceClient) CreateOrUpdateProduct(ctx context.Context, in *CreateOrUpdateProductRequest, opts ...grpc.CallOption) (*CreateOrUpdateProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOrUpdateProductResponse)
	err := c.cc.Invoke(ctx, CatalogService_CreateOrUpdateProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogServiceClient) ListProductsWithIds(ctx context.Context, in *ListProductsWithIdsRequest, opts ...grpc.CallOption) (*ListProductsWithIdsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductsWithIdsResponse)
	err := c.cc.Invoke(ctx, CatalogService_ListProductsWithIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CatalogServiceServer interface {
	...
	ListProductsWithIds(context.Context, *ListProductsWithIdsRequest) (*ListProductsWithIdsResponse, error)
...
func (UnimplementedCatalogServiceServer) CreateOrUpdateProduct(context.Context, *CreateOrUpdateProductRequest) (*CreateOrUpdateProductResponse, error) {
...
func (UnimplementedCatalogServiceServer) ListProductsWithIds(context.Context, *ListProductsWithIdsRequest) (*ListProductsWithIdsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListProductsWithIds not implemented")
}
...
func _CatalogService_CreateOrUpdateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateOrUpdateProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogServiceServer).CreateOrUpdateProduct(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatalogService_CreateOrUpdateProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).CreateOrUpdateProduct(ctx, req.(*CreateOrUpdateProductRequest))
	}
...
func _CatalogService_ListProductsWithIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProductsWithIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogServiceServer).ListProductsWithIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatalogService_ListProductsWithIds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).ListProductsWithIds(ctx, req.(*ListProductsWithIdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _CatalogService_CreateOrUpdateProduct_Handler,
		},
		{
		...
		{
			MethodName: "ListProductsWithIds",
			Handler:    _CatalogService_ListProductsWithIds_Handler,
		},
		{
